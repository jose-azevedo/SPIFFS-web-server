function listar() {
  var tbody = document.getElementById('dataCells')
  var tab = document.getElementById('tabela')
  tbody.remove()
  tbody = document.createElement('tbody')
  tbody.setAttribute('id', 'dataCells')
  ...
  xml.onreadystatechange = function () {
    if ((xml.readyState==4) && (xml.status==200)) { // Quando receber um OK do servidor e a lista bruta, inicia o processamento da lista
      tbody = document.getElementById('dataCells')
      ...
      for (var i = 0; i < dataList.A.length; i++) { // Laço se repete enquanto houverem elementos nos vetores
        ...
        tbody.appendChild(newRow) // Anexação da nova linha ao corpo da tabela
